...
Ниже сохранены условия первоначальной разработки сайта. Актуальное предложение
по SEO и продвижению вынесено в отдельный раздел и не заменяет этот договор.
...
## Предложение по продвижению от 31 июля 2026 года

- **Работы на 90 дней:** 150 000 ₽, тремя платежами по 50 000 ₽.
- **В составе:** SEO, технические доработки, новые страницы, контент,
  Яндекс Бизнес, подготовка рекламы и аналитика.
- **Рекламный бюджет:** рекомендуемые 60 000 ₽ на 90 дней, оплачиваются
  напрямую Яндексу.
- **Общий стартовый бюджет:** 210 000 ₽. Отдельной доплаты 30 000 ₽ за
  Яндекс Бизнес нет.
- **После 90 дней:** выполненные доработки остаются на сайте; рекламу или
  сопровождение 12 000–20 000 ₽ в месяц можно продолжить по желанию.
- **Статус:** предложение отправлено заказчику, ожидается решение.
- **Онлайн-версия:** <https://aiprohar.ru/vizual-commercial-proposal/>.
...
### Предстоит
- [ ] Получить решение заказчика по предложению SEO и Яндекс Бизнес
- [ ] Уточнить у поддержки Topnlab параметры webhook и проверить утверждённый план защиты
- [ ] Реализовать защиту `/api/webhook` в отдельной ветке без изменения production до отдельного согласования

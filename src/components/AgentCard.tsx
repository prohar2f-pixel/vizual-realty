...
export function AgentCard({ name, phone, photo, telegram }: Props) {
  return (
    <div className="rounded-xl border border-stone-200 bg-white p-5 text-center">
      ...
      {telegram && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-3 flex items-center justify-center rounded-md border border-brand px-4 py-2 font-medium text-brand transition hover:bg-brand hover:text-on-brand"
        >
          Написать в Telegram
        </a>
      )}
